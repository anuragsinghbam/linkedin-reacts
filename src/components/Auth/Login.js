                  ...
                  <div className="row">
                    ...
                    <div className="col-sm-12 mb-2">
                      <div className="form-group">
                        ...
                        <input type="password" onChange={(e)=>setpassword(e.target.value)} className="form-control" id="password" placeholder="8 characters or more" /><span className="d-block text-lg-right mt-1">
                          <small><a href="#0">Forgot password?</a></small>
                        </span>
                      </div>
                    </div>
                    <div className="col-sm-12 mb-2">
                      <button type="submit" name="submit" className="btn btn-primary w-100">Log In</button>
                    </div>
